...
let ProjetService = class ProjetService {
    ...
    getProjet() {
        this.http.get('http://localhost:3000/api/projet').subscribe((projet) => {
            if (projet) {
                this.projet = projet;
                this.emitProjet();
            }
    ...
    getProjectById(id) {
        return new Promise((resolve, reject) => {
            this.http.get('http://localhost:3000/api/projet/' + id).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
    ...
    createNewProjectWithFile(project, image) {
        return new Promise((resolve, reject) => {
            ...
            this.http.post('http://localhost:3000/api/projet', projectData).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
    ...
    modifyProjectWithFile(id, project, image) {
        return new Promise((resolve, reject) => {
            ...
            this.http.put('http://localhost:3000/api/projet/' + id, projectData).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
    ...
    deleteProject(id) {
        return new Promise((resolve, reject) => {
            this.http.delete('http://localhost:3000/api/projet/' + id).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
